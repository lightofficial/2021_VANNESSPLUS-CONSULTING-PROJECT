...
<body style="background:#E9E3D7" id="body">
            ...
            <div class="display" style="width:100%">
                ...
                <div class="wrappered" id="halo"><br><br>
                    ...
                    <div class="icon edit">
                        ...
                        <span onclick="updatePositionNav('<?php echo $xx ?>','<?php echo $email ?>')"><i class="fas fa-edit"></i></span>
                    </div>
                    <div class="icon delete">
                        <div class="tooltip">
                            Delete
                        </div>
                        <span onclick="deletePosition('<?php echo $xx ?>','<?php echo $email ?>')"><i class="fas fa-trash-alt"></i></span>
                    </div>
                </div><br>
                    ...
                    <script>
                        $(document).ready(function() {
                            $('#checkBtn').click(function() {
                                ...
                                if (!checked) {
                                    ...
                                    console.log(jobId);
                                    $.ajax({
                                        url: "views/modals/moveCandidate.php",
                                        method: "post",
                                        data: {
                                            id: id,
                                            email: email,
                        ...
                        $(document).ready(function() {
                            $('#checkBtn1').click(function() {
                                ...
                                if (!checked) {
                                    ...
                                    console.log(canId);
                                    $.ajax({
                                        url: "views/modals/sendEmailModal.php",
                                        method: "post",
                                        data: {
                                            id: id,
                                            email: email,
                        ...
                        $(document).ready(function() {
                            $('#checkBtn2').click(function() {
                                ...
                                if (!checked) {
                                    ...
                                    console.log(jobId);
                                    $.ajax({
                                        url: "views/modals/dropCandidateNavAll.php",
                                        method: "post",
                                        data: {
                                            id: id,
                                            email: email,
                        ...
                        $(document).ready(function() {
                            $('#checkBtn3').click(function() {
                                ...
                                if (!checked) {
                                    ...
                                    console.log(jobId);
                                    $.ajax({
                                        url: "views/modals/removeCandidateNavAll.php",
                                        method: "post",
                                        data: {
                                            id: id,
                                            email: email,
                        ...
                        $(document).ready(function() {
                            $('#checkBtn4').click(function() {
                                ...
                                console.log(jobId);
                                $.ajax({
                                    url: "views/modals/droptCandidateNav.php",
                                    method: "post",
                                    data: {
                                        email: email,
                                        jobId: jobId
        ...
        function addCandidate(xxx, email) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    jQuery.noConflict();
                    $('#dataModal').modal({"backdrop": "static"});
                }
            });

        };

        function updatePositionNav(xxx, email) {
            var bId = xxx;
            var email = email;
            console.log(email);
            $.ajax({
                url: "views/modals/editJobNav.php",
                method: "post",
                data: {
                    bId: bId,
                    email: email
    ...
    <script>
        function deletePosition(xxx, email) {
            ...
            console.log(jobId);
            $.ajax({
                url: "views/modals/deleteJobNav.php",
                method: "post",
                data: {
                    jobId: jobId,
                    email: email
    ...
    <script>
        function editCandidate(xxx, email, zzz) {
            ...
            console.log(jobId);
            $.ajax({
                url: "views/modals/editCandidateNav.php",
                method: "post",
                data: {
                    canId: canId,
                    email: email,
        ...
        function dropCandidate(xxx, email, zzz) {
            ...
            console.log(jobId);
            $.ajax({
                url: "views/modals/dropCandidateNav.php",
                method: "post",
                data: {
                    applyId: applyId,
                    email: email,
        ...
        function removeCandidate(xxx, email, zzz) {
            ...
            console.log(jobId);
            $.ajax({
                url: "views/modals/removeCandidateNav.php",
                method: "post",
                data: {
                    applyId: applyId,
                    email: email,
