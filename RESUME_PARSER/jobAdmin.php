        ...
        <main>
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover table-responsive-lg" id="wtf1">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $uId = $fetch_info['id'];
                            $sql = "SELECT * FROM job natural join jobstatus WHERE id='$uId' order by jobId";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <!-- <td><i id="gg" class="fas fa-edit" onclick="updatePosition('<?php echo $row['jobId'] ?>','<?php echo $email ?>','<?php echo $uId ?>')"></i></td> -->
                                    <!-- <td><?php echo $row['keySkill'] ?></td> -->
                                    <td style="text-align: center;"><?php echo $row['quantity'] ?></td>
                                    <td><?php echo $row['jobLocation'] ?></td>
                                    <td style="text-align: center;"><?php echo $row['jobStatus'] ?></td>
                                    <td style="text-align: center;"><?php echo $row['jobCreateDate'] ?></td>
                                    <td><i id="gg" class="fas fa-user-plus" onClick="window.location='navAdmin.php?var=<?php echo $row['jobId'] ?>'"></i></td>
            ...
            <script>
                function deletePosition(xxx, email) {
                    ...
                    console.log(jobId);
                    $.ajax({
                        url: "views/modals/deleteJobAdmin.php",
                        method: "post",
                        data: {
                            jobId: jobId,
                            email: email
            ...
            <script>
                function updatePosition(xxx, email, uid) {
                    var bId = xxx;
                    var email = email;
                    var uId = uid;
                    console.log(email);
                    $.ajax({
                        url: "views/modals/editJobAdmin.php",
                        method: "post",
                        data: {
                            bId: bId,
                            email: email,
            ...
            <script>
                function view_data(xxx) {
                    ...
                    $.ajax({
                        url: "views/modals/viewAdmin.php",
                        method: "post",
                        data: {
                            bId: bId
                        },
                ...
                <div class="modal-dialog" style="max-width:500px">
                    <div class="modal-content" id="upload">
                        ...
                        <form action="views/action/upload.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                <input type="submit" style="background-color:#5757d1;border-radius: 5px;color:#ffffff" class="btn" name="upload2" value="Upload">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog" style="max-width: 500px;">
                    <div class="modal-content">
                        ...
                        <form action="views/action/updateStatusJob.php" method="POST">
                            ...
                            <div class="modal-footer">
                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                <input type="submit" style="background-color:#5757d1;border-radius: 5px;color:#ffffff" class="btn" name="changeJob2" value="Change">
                            </div>
                        </form>
                    </div>
                </div>
